          ...
          <div className='flex flex-col sm:flex-row gap-5 md:justify-evenly mt-20 items-start mx-auto'>
            <div className='flex gap-5 items-center justify-center md:justify-start'>
              <Image
                ...
                height={14}
              />
              <p className='text-lg font-semibold'>Dekorasi Elegan & Modern</p>
            </div>
            <div className='flex gap-5 items-center justify-center md:justify-start'>
              <Image
                src='/images/manage/right.svg'
                ...
                height={14}
              />
              <p className='text-lg font-semibold'>Tim Berpengalaman</p>
            </div>
            <div className='flex gap-5 items-center justify-center md:justify-start'>
              <Image
                src='/images/manage/right.svg'
                ...
                height={14}
              />
              <p className='text-lg font-semibold'>Melayani Jabodetabek</p>
            </div>
          </div>
        </div>
        {/*  */}
